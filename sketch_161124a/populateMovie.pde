...
//Populate single movs
   singles = new Movie[]{
    ...
    new Movie(this, "nature/amoeba1A.mov"),
    new Movie(this, "nature/clouds.mov"),
    new Movie(this, "nature/frog.mov"),
    new Movie(this, "nature/stream.mov"),
...
other = new Movie[]{
  ...
  new Movie(this, "nature/amoeba2B.mov"),
  new Movie(this, "nature/coloramoeba.mov"),
  new Movie(this, "nature/flower1.mov"),
  new Movie(this, "nature/fly1.mov"),
  new Movie(this, "nature/spinning1.mov"),
  new Movie(this, "nature/tree1.mov"),
  new Movie(this, "nature/waterfall.mov"),
